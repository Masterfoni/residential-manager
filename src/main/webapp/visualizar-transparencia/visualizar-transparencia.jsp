    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="page-header">
                ...
                <form class="form-inline" action="ServletTransparencia" method="post" role="form">
                    <div class="form-group">
                        <input type="hidden" name="ACTION" value="SELECTANO"/>
                        <label for="selectAno">Ano das despesas: </label>
                        <select id="selectAno" class="form-control" name="valAno" onchange="this.form.submit()">
